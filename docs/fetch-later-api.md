...
1. The top-level document and its same-origin descendants can use up the full 640KB (unless a `https://b.com` subframe is created in which case they are left with 576KB).
